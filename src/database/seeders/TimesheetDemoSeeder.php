    ...
    public function run(): void
    {
        ...
        DB::table('t_compliance_issues')->insert([
            [
                ...
                'severity' => 'CRITICAL',
                'description' => 'Nhân viên Nguyễn Văn Quản Trị đã vượt quá giới hạn giờ làm thêm trong tháng 05/2026 (Đã làm 52.5 giờ thêm, vượt quá giới hạn 45 giờ/tháng theo Thỏa ước lao động 36).',
                'status' => 'OPEN',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'severity' => 'CRITICAL',
                'description' => 'Thẻ lưu trú (Zairyu Card) của nhân viên Trần Thị Nhân Sự đã hết hạn vào ngày 15/05/2026. Cần cập nhật thẻ cư trú mới hoặc làm thủ tục gia hạn khẩn cấp để tránh vi phạm nghiêm trọng luật pháp lao động Nhật Bản.',
                'status' => 'OPEN',
                'created_at' => now(),
                'updated_at' => now(),
            ],
